...
# Load data
data <- readxl::read_excel("C:/Users/mauri/OneDrive/Desktop/Projects/R Projects/Smartphone_Usage_And_Addiction_Analysis.xlsx")
data %>% head()
View(data)
...
const PROJECT_SECTION_CONFIGS = [
  ...
  },
  {
    ...
    headerDesc: 'The ttached views for R reports for data modelling.',
    tabs: [
      {
        id: 'r-pdf-analysis1',
        label: 'Report on Mental Health Risk Modelling (PDF)',
      ...
      {
        id: 'r-pdf-analysis2',
        label: 'Report on Mental Health Risk Modelling (HTML)',
        title: 'Mental Health Risk Modelling',
        kind: 'pdf',
        src: 'Mental-Health.html',
      },
      {
        id: 'r-pdf-paper1',
        label: 'Report on Smartphone Usage and Addiction Modelling (PDF)',
        title: 'Smartphone Usage and Addiction Modelling',
        kind: 'pdf',
        src: 'Smartphone-Addiction-Report.pdf',
      },
      {
        id: 'r-pdf-paper2',
        label: 'Report on Smartphone Usage and Addiction Modelling (HTML)',
        title: 'Smartphone Usage and Addiction Modelling',
        kind: 'pdf',
        src: 'Smartphone-Addiction-HTML.html',
      },
    ],
  },
  {
    ...
    tabs: [
      ...
      },
      {
        ...
        title: 'Presentation',
        kind: 'pdf',
        src: 'Smartphone-Addiction-Slides.html',
      },
      {
      ...
      },
      {
        ...
        title: 'Infographic',
        kind: 'image',
        src: 'Data Science Skillset 2.png',
      },
    ],
  },
  {
    ...
    headerDesc: 'This panel provides an interactive preview of the Shiny Dashboards',
    link: 'https://juma-maurice.shinyapps.io/mental_health_risk/',
    tabs: [
      {
        id: 'r-shiny-live1',
        ...
        kind: 'pdf',
        src: 'https://juma-maurice.shinyapps.io/smartphone_addiction_folder/',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    headerTitle: 'Python Dashboard',
    headerDesc: 'This dashboard showcases interactive analytics built with Python and Streamlit. It provides a live view of student impact data, enabling users to explore trends, visualize outcomes, and gain insights through dynamic charts and metrics.',
    tabs: [
      {
        ...
        title: 'Live App',
        kind: 'pdf',
        src: 'https://data-science-ai-student-impact.streamlit.app/',
      },
    ],
  },
  {
...
function renderProjectAsset(tab) {
  ...
  if (tab.kind === 'pdf') {
    // Horizontal-only scroll wrapper for PDFs
    return `
      <div style="width:100%; height:500px; overflow-x:auto; overflow-y:hidden; white-space:nowrap;">
        <iframe id="${tab.id}"
                src="${tab.src}"
                title="${tab.title || tab.label}"
                width="1280px" height="500px"
                frameborder="0" style="display:inline-block;">
        </iframe>
      </div>`;
  }
